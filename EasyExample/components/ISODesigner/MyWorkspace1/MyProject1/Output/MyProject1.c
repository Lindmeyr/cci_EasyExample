...
const unsigned char ISO_OP_MEMORY_CLASS isoOP_MyProject1[] = {
	...
	ID(DataMask_Home), TYPEID_DATAMASK, COLOR(230), ID(SoftKeyMask_Home), 7, 0, 
		...
		XYREF(Container_Gesamtzaehler, 205, -3),
		XYREF(Container_Tageszaehler, 3, 1),
		XYREF(OutputString_ZielErreicht, 500, 150),
		XYREF(Button_PlusPlus, 400, 400),
		XYREF(Button_MinusMinus, 401, 317),
	...
	ID(Button_PlusPlus), TYPEID_BUTTON, WORD(80), WORD(80), 187, 12, 1, 0, 1, 0, 
