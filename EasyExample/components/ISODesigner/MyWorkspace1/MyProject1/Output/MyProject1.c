...
const unsigned char ISO_OP_MEMORY_CLASS isoOP_MyProject1[] = {
	...
	ID(Macro_2), TYPEID_MACRO, WORD(8),
		CMD_CHANGE_ACTIVE_MASK, ID(WorkingSet_0), ID(Seite2), 0xFF, 0xFF, 0xFF,
	...
	ID(DataMask_Home), TYPEID_DATAMASK, COLOR(230), ID(SoftKeyMask_Home), 8, 0, 
		...
		XYREF(Button_S2, 397, 136),
	ID(Seite2), TYPEID_DATAMASK, COLOR(230), ID(ID_NULL), 1, 0, 
		XYREF(Button_s1, 4, 4),
	ID(DataMask_Seite_2), TYPEID_DATAMASK, COLOR(230), ID(ID_NULL), 0, 0, 
	...
	ID(Button_S2), TYPEID_BUTTON, WORD(78), WORD(68), 10, 12, 1, 0, 1, 1, 
		XYREF(OutputString_S2, -4, 20),
		MACRO(EV_KEYRELEASE, Macro_2),
	ID(Button_s1), TYPEID_BUTTON, WORD(84), WORD(82), 10, 12, 1, 0, 1, 1, 
		XYREF(OutputString_s1, -4, 27),
	...
	ID(OutputString_S2), TYPEID_OUTSTR, WORD(78), WORD(20), COLOR_WHITE, ID(FontAttributes_23000), 1,
		ID(ID_NULL), 5, WORD(4), 'S', '2', ' ', ' ', 0,
	...
	ID(OutputString_Reset_Tageszaehler), TYPEID_OUTSTR, WORD(112), WORD(52), COLOR_WHITE, ID(FontAttributes_Default), 3,
		...
		'T', 'a', 'g', 'e', 's', 0,
	ID(OutputString_s1), TYPEID_OUTSTR, WORD(84), WORD(20), COLOR_WHITE, ID(FontAttributes_23000), 1,
		ID(ID_NULL), 5, WORD(4), 'S', '1', ' ', ' ', 0,
