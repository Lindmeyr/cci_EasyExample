...
const unsigned char ISO_OP_MEMORY_CLASS isoOP_MyProject1[] = {
	...
	ID(Button_S2), TYPEID_BUTTON, WORD(78), WORD(75), 249, 249, 1, 0, 1, 1, 
		XYREF(OutputString_S2, -4, 24),
		MACRO(EV_KEYRELEASE, Macro_1),
	ID(Button_Seite1), TYPEID_BUTTON, WORD(75), WORD(80), 249, 249, 1, 0, 1, 1, 
		XYREF(OutputString_11006, -4, 26),
	...
	ID(OutputString_Reset_Tageszaehler), TYPEID_OUTSTR, WORD(112), WORD(52), COLOR_WHITE, ID(FontAttributes_Default), 3,
		...
		'T', 'a', 'g', 'e', 's', 0,
	ID(OutputString_11006), TYPEID_OUTSTR, WORD(75), WORD(20), COLOR_WHITE, ID(FontAttributes_23000), 1,
